  ...
  return (
    <div className='add-employee-page'>
      ...
      <form onSubmit={handleSubmit}>
        <input type='text' name= "name" placeholder='Employee Name' value={formData.name} className='form-input' onChange={handleChange}  required />
        ...
        <input type='email' placeholder='Employee Email'  name="email" value={formData.email} className='form-input' onChange={handleChange}  required />
